      ...
      <div className="container mx-auto px-4 max-w-7xl flex items-center justify-between">
        ...
        <nav className="hidden xl:flex items-center space-x-4 xl:space-x-5">
          {navLinks.map((link) => (
            <Link
              key={link.name}
              href={link.href}
              className="relative text-sm font-medium text-white/95 hover:text-gold transition-colors group"
            >
              {link.name}
        ...
        <div className="hidden xl:flex items-center space-x-3">
          <motion.a
            ...
            className="px-5 py-2.5 text-sm font-semibold text-white border-2 border-white/20 rounded-full hover:bg-white/10 hover:text-white transition-all duration-300 flex items-center hover-lift group"
          >
        ...
        <div className="flex xl:hidden items-center space-x-2">
          <a
            ...
            rel="noreferrer"
            aria-label="Contact via WhatsApp"
            className="p-2 bg-[#25D366] text-white rounded-full hover:scale-105 transition-transform flex items-center justify-center shadow-md"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div 
            ...
            className="xl:hidden absolute top-full left-0 w-full bg-[#0A0F1D] shadow-2xl border-t border-white/10 overflow-hidden z-[100]"
          >
            <div className="py-4 px-4 flex flex-col space-y-4">
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-base font-medium text-white hover:text-gold block py-2 border-b border-white/10"
              ...
              >
                <a
                  ...
                  aria-label="Contact via WhatsApp"
                  className="w-full flex justify-center items-center px-4 py-3 text-sm font-medium text-white border border-white/20 rounded-md bg-white/5 hover:bg-white/10"
                >
