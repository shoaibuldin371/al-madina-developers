    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 pointer-events-none">
      ...
      >
        <motion.a
          ...
          className={`w-14 h-14 bg-navy text-white rounded-full flex items-center justify-center shadow-lg group border border-white/20 relative transition-all duration-300 ${
      ...
      >
        <motion.a
          ...
          className={`w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg group border border-white/20 relative transition-all duration-300 ${
            isNearBottom ? 'opacity-40 hover:opacity-100 scale-90 hover:scale-100' : 'opacity-100 hover:scale-105'
          }`}
          aria-label="WhatsApp"
        >
          ...
          <svg className="w-7 h-7 relative z-10 drop-shadow-md text-white" fill="currentColor" viewBox="0 0 24 24">
